...
For a detailed write-up, see [Solution Overview](./artifacts/docs/SOLUTION_OVERVIEW.md) and [Architecture](./artifacts/docs/ARCHITECTURE.md). A complete self-contained explainer is provided at [`intelliai_explainer.html`](./artifacts/docs/intelliai_explainer.html).
...
| Folder | Contents |
|---|---|
| `artifacts/demo/` | Demo video, screenshots, GIFs, pitch deck |
| `artifacts/docs/` | Architecture, solution overview, API and workflow documentation, [`intelliai_explainer.html`](./artifacts/docs/intelliai_explainer.html) |
| `artifacts/output/` | Migration plans, validation evidence, rollback evidence, operability and test results |
...
| Name | Role | GitHub |
|---|---|---|
| _TODO: name_ | _TODO: role_ | _TODO: @handle_ |
| _TODO: name_ | _TODO: role_ | _TODO: @handle_ |
| _TODO: name_ | _TODO: role_ | _TODO: @handle_ |
| _TODO: name_ | _TODO: role_ | _TODO: @handle_ |
...
*Built for the IBM MQ API Hackathon 2026 — Phase 2*
